...
A collection of PHP extensions bundled as Docker images that make it super simple to add & enable extensions in your
PHP Docker images.

Supported PHP versions: 8.0, 8.1
...
Using  an extension in your image is a simple process consisting of two steps:

1. Copy in the files generated by the extension.
2. Run a setup script that installs any additional packages & performs any additional setup required by the extension.

The sample Dockerfile below shows how to add in extensions:

```dockerfile
FROM php:8.0.22-cli-alpine3.15
...
The table below shows the available extensions, as well as which platforms they're available for:

| extension  | linux/amd64 | linux/arm64 |
|------------|-------------|-------------|
| amqp       | ✅           | ✅           |
| apcu       | ✅           | ✅           |
| bcmath     | ✅           | ✅           |
